...
class AboutUsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Setting::set('about_us_content', <<<'HTML'
            <p>Welcome to Sample E-Commerse, your one-stop destination for electronics, fashion, and home essentials. Since our founding, we've been committed to bringing quality products to your doorstep at honest prices.</p>
            ...
            <p>Thank you for choosing Sample E-Commerse. We're glad to have you with us!</p>
            HTML);
    }
}
