...
<div class="form-group">
    ...
    <small style="color: var(--text-muted);">Internal note listing the available double-curly-brace variables for this template (e.g. name, otp). Note: @{{ site_name }} and @{{ primary_color }} are always available in every template.</small>
</div>
